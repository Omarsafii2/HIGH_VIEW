									...
									foreach ($categories as $category) { ?>
										<div class="d-flex border">
											<a href="/category/filter?category_id=<?php echo $category['id']; ?>" class="link-hover">
												<img src="<?php echo $category['img']; ?>" alt="" width="50px" height="50px" class="mr-3 border rounded">
						...
						foreach ($products as $product) { ?>
							<div class="single-product m-1 border shadow-lg p-3 bg-white rounded hoveer">
								<a href="/category/details?product_id=<?php echo $product['id']; ?>">
									<img class="img-fluid" src="<?php echo $product['front_view']; ?>" loading="lazy">
									<hr>
						...
						<?php foreach ($discount as $product): ?>
							...
							<div class="col-md-4 mb-4">
								<div class="product-item border p-3 h-100 text-center">
									<img src="<?php echo htmlspecialchars($product['img']); ?>" alt="Product Image" class="img-fluid mb-3" style="height: 200px; width: auto;">
				...
				<div class="col-lg-3">
					<div class="ctg-right">
						<a href="#" target="_blank">
							<img class="img-fluid d-block mx-auto" src="../views/public/images/discountImg.avif" alt="">
						</a>
					</div>
				</div>
			</div>
