                ...
                <div class="table-responsive">
                    <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="product_count">
                                                <input type="number" name="qty[<?php echo $item['product_id']; ?>]" value="<?php echo htmlspecialchars($item['quantity']); ?>">
                                        ...
                                        <td>
                                            <form method="post" action="/user/delete" id="deleteForm_<?= $item['id'] ?>">
                        ...
                        <tr class="bottom_button">
                            ...
                            <td>
                                <div style="width: 250px;">&nbsp;</div> <!-- Placeholder for spacing -->
                            </td>
                            <td>
                                <div style="width: 150px;">&nbsp;</div> <!-- Placeholder for spacing -->
                            </td>
                            <td>
                            ...
                            <td>
                                <form action="/cart/coupon" method="post">
                                    <div class="cupon_text d-flex align-items-center">
                                        ...
                                        <button class="primary-btn" type="reset"><i class="fas fa-times"></i> Close Coupon</button>
                                    </div>
                                </form>
                            </td>
                        </tr>
