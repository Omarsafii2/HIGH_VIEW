...
class AuthSystem {
  ...
  // Register a new user
  public function registerUser($first_name, $last_name, $email, $phone, $password, $confirm_password) {
    ...
    if ($password !== $confirm_password) {
      ...
      if ($user) {
        ...
        $this->db->register($first_name, $last_name, $email, $phone,  $hashed_password,  $hashed_password);
...
if (isset($_POST['register'])) {
  $authSystem->registerUser($_POST['first_name'], $_POST['last_name'], $_POST['email'], $_POST['phone'], $_POST['password'], $_POST['confirm_password']);
