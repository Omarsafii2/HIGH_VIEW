				...
				<div class="sidebar-categories">
					...
					<?php
								...
								foreach ($category_name as $category_name)
									{ ?>
									 <div class=" d-flex border "><a href="" class="text-primary" ><img src="img/category_img/<?=$category_name['name']?>.png" alt="" width="50px" height="50px" class="mr-3 border rounded"	><?php echo $category_name['name'] ." >> <br>";?> </a></div>
									<?php } ?>
